...
function GetCashForm ({setCash, cash}) {
    const cashRef = useRef(null);

    function handlerCash ( ) {
       // setCash(cashRef.current.value);
        setCash(Number(cash) + Number(cashRef.current.value))
    }
    ...
    return (
        <>
            ...
            <section className=" bg-blue-950 flex-wrap py-10 gap-4 flex justify-center w-2/3 mx-auto">
                <input type="number" className="font-black md:px-1" placeholder="Digite a verba Inicial ou incremente a verba: " ref={cashRef}/>
